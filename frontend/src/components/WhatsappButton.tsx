...
export function WhatsappButton() {
  return (
    <a
      ...
      className="fixed right-5 bottom-5 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-olive text-ivory shadow-lg transition-colors hover:bg-ink sm:h-14 sm:w-14"
    >
